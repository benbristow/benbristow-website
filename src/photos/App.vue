<template>
  ...
  <div v-else-if="photos?.length > 0">
    <h3 class="mb-4"><i class="fa fa-camera"></i> My recent photos on <a href="https://www.flickr.com/photos/benbrist" target="_blank" rel="noopener noreferrer">Flickr</a></h3>
